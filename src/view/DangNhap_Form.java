...
import static view.FromXacNhanCa.lblEmail;
...
public class DangNhap_Form extends javax.swing.JFrame {
    ...
    GiaoCa_sevrIPML gc = new GiaoCa_sevrIPML();
    ...
    private void lblDangNhapMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblDangNhapMouseClicked
        if (checkForm()) {
            if (dangNhap_Serv.checkDN(txtEmail.getText(), String.valueOf(txtMatKHau.getPassword()))) {
                ...
                if (dangNhap_Serv.checkDNChuCh(txtEmail.getText(), String.valueOf(txtMatKHau.getPassword())) || Giaoca.checkTonTaiCaLam()) {
                    Menu m = new Menu();
                    m.txtTenNhanVien.setText(tenNv);
                    m.setVisible(true);

                } else {
                    FromXacNhanCa cn = new FromXacNhanCa();
                    cn.lblEmail.setText(txtEmail.getText());
                    cn.setVisible(true);
