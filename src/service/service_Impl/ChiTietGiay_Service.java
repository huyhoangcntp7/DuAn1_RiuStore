...
public class ChiTietGiay_Service implements ChiTietGiay_Service_impl{
    ...
    @Override
    public boolean checkTrungMa(String maGiay) {
        return chiTietGiayRP.checkTrungMa(maGiay);
    }

    @Override
    public boolean checkTrungMaBarCode(String maBarCode) {
        return chiTietGiayRP.checkTrungMaBarcode(maBarCode);
    }
