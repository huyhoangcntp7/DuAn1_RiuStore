...
public class ThongKe_ViewModel {
    ...
    private int tt;
    private String maHD,lidoHuy;

    public ThongKe_ViewModel() {
    }

    public ThongKe_ViewModel(String maSp, String tenSp, String mau, String size, String chatLieu, int slTon, int slBan, double donGia, double doanhThu, double tienmat, double tienkhac, double tiengiamgia, double gianhap, String ngaytao, String namBH, int tt, String maHD, String lidoHuy) {
        this.maSp = maSp;
        this.tenSp = tenSp;
        this.mau = mau;
        this.size = size;
